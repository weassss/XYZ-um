      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center mb-12">
          <p className="text-lg font-semibold mb-4">
            Notre volonté est de vous simplifier la vie.
          </p>
          <p className="text-sm text-gray-600">
            C'est pour cette raison que de nombreuses compagnies de renommée
            mondiale nous font confiance depuis plusieurs décennies.
          </p>
        </div>
        ...
        <div className="flex flex-wrap -mx-4 justify-center">
          ...
          <div className="w-full md:w-1/3 px-4 mb-8 md:mb-0 text-center">
            <Image
              src="/Logo_UM_2020_fond-transparent.webp"
              alt="Umallette Logo"
              width={100}
              height={40}
            ...
            <div className="flex justify-center space-x-4 mb-4">
              <Link
                href="https://www.facebook.com/umallette/"
                target="_blank"
              ...
              <Link
                href="https://www.linkedin.com/company/um-inc/?originalSubdomain=ca"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-gray-600"
              >
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-wrap justify-center items-center">
          <p className="text-sm text-gray-600 mb-4 md:mb-0 md:mr-4">
            © 2024 Umallette Manufacturing. All rights reserved.
          </p>
